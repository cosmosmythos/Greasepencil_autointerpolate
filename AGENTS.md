...
| Child | Scope |
|-------|-------|
| `.github/AGENTS.md` | CI workflows: build matrix, wheel packaging, release automation |
| `Addon/AGENTS.md` | Blender addon package: operators, UI panels, core engine, utilities |
| `Addon/core/AGENTS.md` | Core engine: C++ module loading, cache, interpolation pipeline, registry, depsgraph handlers |
| `Addon/operators/AGENTS.md` | Blender operators: bake, toggle, refresh, easing, correspondence, arc, layer, line art |
